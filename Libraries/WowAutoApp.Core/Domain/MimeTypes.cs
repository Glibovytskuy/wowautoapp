namespace WowAutoApp.Core.Domain
{
    public static class MimeTypes
    {
        ...
        /// Type
        /// </summary>
        public const string ImgSvgXml = "image/svg+xml";

        /// <summary>
        /// Type
        /// </summary>
        public const string ImgVndMicrosoftIcon = "image/vnd.microsoft.icon";

        /// <summary>
        /// Type
        /// </summary>
        public const string ImgVndWapWbmp = "image/vnd.wap.wbmp";

        /// <summary>
        /// Type
        /// </summary>
        public const string ImgWebp = "image/webp";
